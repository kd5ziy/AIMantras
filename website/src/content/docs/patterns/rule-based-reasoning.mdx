...
| Pair With | When |
|-----------|------|
| [Chain of Thought](/patterns/chain-of-thought/) | Each stage cites specific rules |
| [Meta Rules](/patterns/meta-rules/) | Stylistic or tone requirements exist |
| Clara, Kestra, Ada personas | Compliance and rigor dominate |
