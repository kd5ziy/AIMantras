...
| Pair With | When |
|-----------|------|
| [Planning Phase](/patterns/planning-phase/) | Feed the planner section |
| [Recursive Self-Eval](/patterns/recursive-self-eval/) | Stronger critique in QA |
| Specialized patterns | Workers use chain-of-thought, guardrail, etc. |
