...
description: Tackle multi-domain, high-complexity problems that require integrating perspectives across disciplines.
---
...
| Pattern | When to Use |
|---------|-------------|
| [Chain of Thought](/patterns/chain-of-thought/) | Expose multi-layer reasoning |
| [Meta Rules](/patterns/meta-rules/) | Tone/constraints propagate across sub-domains |
| [Orchestration](/patterns/orchestration/) | Coordinating multiple worker personas |
| [Recursive Self-Eval](/patterns/recursive-self-eval/) | Self-QA long reasoning chains |

## Example Invocations

```text
Persona: Franklin. Task: Design an AI-assisted investment research workflow
that blends Clara's financial rigor with Kestra's infra automation and
Goeth's ethical framing. Inputs: research-playbook.md.
Patterns: chain-of-thought + orchestration.
```

```text
Persona: Franklin. Task: Evaluate the societal implications of deploying
homelab AI monitoring for community resilience. Inputs: homelab-notes.md,
philosophy.md. Patterns: meta-rules + recursive-self-eval.
```
