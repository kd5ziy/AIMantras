...
- **Where:** All content lives under `Prompt-AI-Mantras/` with `personas/`, `patterns/`, and `projects/` folders plus repo-wide context files.
- **How to start:**
  1. Read `Prompt-AI-Mantras/README.md` (usage) + `development/agents.md` (current state) if you're jumping in midstream.
